...
import 'package:expense_tracker2/models/expense.dart' as exp;
...
class _NewExpenseState extends State<NewExpense> {
  ...
  exp.Category _selectedCategory = exp.Category.leisure;
  ...
  void _showDialog(){
    if(Platform.isIOS){
      showCupertinoDialog(context: context, builder: (ctx)=> CupertinoAlertDialog(
        ...
        content: const Text('Make sure a valid title, amount and date were eneterd.'),
        actions: [
